...
public class MapController {
	...
	@GetMapping("/{text}")
	private ResponseEntity<List<NaviDto>> navi(
			@PathVariable("text") @ApiParam(value = "검색어", required = true) String text) throws SQLException {
	...
	private ResponseEntity<List<CoronaDto>> corona(
			@PathVariable("gugun") @ApiParam(value = "구군코드.", required = true) String gugun) throws SQLException {
	...
	private ResponseEntity<List<HospitalDto>> hospital(
			@PathVariable("gugun") @ApiParam(value = "구군코드.", required = true) String gugun) throws SQLException {
	...
	private ResponseEntity<String> delinter(
			@PathVariable("dong") @ApiParam(value = "동코드.", required = true) String dong,
			@PathVariable("userId") @ApiParam(value = "유저아이디.", required = true) String userId) throws SQLException {
		Map<String, String> map = new HashMap<String, String>();
	...
	private ResponseEntity<List<MapDto>> search(
			@PathVariable("dong") @ApiParam(value = "동코드.", required = true) String dong,
			@PathVariable("year") @ApiParam(value = "연도", required = true) String year,
			@PathVariable("month") @ApiParam(value = "월", required = true) String month) throws SQLException {
