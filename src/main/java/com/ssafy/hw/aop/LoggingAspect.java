...
public class LoggingAspect {
	...
	@Around(value = "execution(* com.ssafy.hw..model..*.*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.hw..model..*.*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.hw..model..*.*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.hw..model..*.*(..))")
